    ...
    <footer className="bg-neutral-50 border-t border-neutral-200">
      <div className="w-full px-[10%] sm:px-[8%] lg:px-[5%] py-4">
        <div className="flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="space-y-4">
            <h4 className="text-sm lg:text-base font-medium text-neutral-600 text-center">social</h4>
            <div className="flex flex-wrap gap-3">
              <Link
                href="https://vercel.com/miles-projects-a6445319/milesy1-github-io"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-3 py-2 bg-white border border-neutral-200 rounded-lg text-xs text-neutral-600 hover:border-primary-200 hover:text-primary-600 transition-colors duration-200"
              >
          ...
          <div className="space-y-4">
            <h4 className="text-sm lg:text-base font-medium text-neutral-600 text-center">stack</h4>
